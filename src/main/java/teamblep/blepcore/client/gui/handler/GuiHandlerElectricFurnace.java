...
public class GuiHandlerElectricFurnace extends
    GuiHandlerMachine<ContainerElectricFurnace, GuiElectricFurnace, TileEntityElectricFurnace> {

  @Override
  protected ContainerElectricFurnace getContainer(EntityPlayer player, World world, BlockPos pos) {
    return new ContainerElectricFurnace(player.inventory,
        (TileEntityElectricFurnace) world.getTileEntity(pos));
  }
