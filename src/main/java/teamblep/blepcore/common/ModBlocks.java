...
@ObjectHolder(value = BlepCore.MOD_ID) @EventBusSubscriber public class ModBlocks {
...
//    public static final Item EXAMPLE_BLOCK_ITEM = null;
    @ObjectHolder("electric_furnace") public static final ItemBlock ELECTRIC_FURNACE_ITEM = null;

    @SubscribeEvent public static void onRegisterBlocks(Register<Block> event) {
