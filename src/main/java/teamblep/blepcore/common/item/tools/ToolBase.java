...
public abstract class ToolBase extends ItemBase {
     ...
     */
    public abstract boolean rightClickBlockAction(EntityPlayer player, EnumHand hand, World world, BlockPos pos,
     ...
     * @return true if an action is performed and false if not
     */
    public abstract boolean leftClickBlockAction(EntityPlayer player, EnumHand hand, World world, BlockPos pos,
                                                 IBlockState blockState, EnumFacing side, Vec3d hit);
